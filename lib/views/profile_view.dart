...
import 'package:carpik_kaldirimlar/views/profile_view_helpers.dart';
            ...
            child: NestedScrollView(
              ...
              body: TabBarView(
                children: [
                      ...
                      children: [
                        ...
                        if (userPosts.isEmpty)
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text('Henüz hiç yazı paylaşmadın.', style: theme.textTheme.bodyLarge),
                                const SizedBox(height: 16),
                                OutlinedButton(
                                   onPressed: () => context.go('/create-post'),
                                   child: const Text('İlk yazını paylaş'),
                                ),
                              ],
                            ),
                          )
                  ...
                  // COMMENTS TAB
                  UserCommentsList(userId: authService.currentUserId ?? ''),
                ],
              ),
            ),
          ),
